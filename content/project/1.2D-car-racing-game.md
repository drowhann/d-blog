---
title: 'A 2D Car Racing Game'
description: 'This is a 2D car racing game built using C language.'
image: '/images/car-racing-game.webp'
date: '2023-11-18'
author: 'Rohan Dhimal'
tags:
  - c
...
This is a 2D car racing game built using `C language`. This game is built using `graphic.h` library in `Turbo C++`. This is
a simple game where you have to dodge the incoming cars. The game ends when you collide with any of the incoming cars.
I built this as a project for my first semester.

<br>

<iframe width="560" height="315" style="max-width:100%" src="https://www.youtube.com/embed/EVDyhdlghNI?si=8Xm_TNa6tqEsdNbG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
You can also find the source code in my [GitHub](https://github.com/drowhannn/projecti-a-2d-car-racing-game-c){:target="\_blank"} repository.

<br>

<!-- I have also made a video on how to build this game. You can find the video in my [YouTube](https://www.youtube.com/watch?v=EVDyhdlghNI&ab_channel=theProgrammingBot). -->
