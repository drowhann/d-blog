<template>
  <div :class="$colormode.isDarkMode.value ? 'dark' : ''">
    <div class="bg-gray-100 dark:bg-gray-900  dark:text-gray-100 text-gray-900 min-h-[100vh]">
      <nav class="px-4 py-2 md:px-8 md:py-4">
        <section class="flex justify-between items-center">
          <NuxtLink to="/" class="text-2xl font-bold">drowhann.</NuxtLink>
          <div class="flex gap-4 items-center">
            <NuxtLink to="/blog" class="text-lg font-bold uppercase">Blogs</NuxtLink>
            <NuxtLink to="/project" class="text-lg font-bold uppercase">Projects</NuxtLink>
            <div class="w-5 h-5 dark:bg-gray-100 bg-gray-900 rounded-full cursor-pointer"
      ...
      <footer class="px-4 py-2 md:px-8 md:py-4">
        <section class="text-sm max-w-7xl mx-auto flex flex-col gap-4 items-center">
          ...
          <div class="flex justify-center items-center gap-1">
            <NuxtLink target="blank" to="https://github.com/drowhannn">
            ...
            <NuxtLink target="blank" to="https://www.linkedin.com/in/rohan-dhimal/">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24">
                <path fill="currentColor"
            ...
            <NuxtLink target="blank" to="https://github.com/drowhannn">
              <svg xmlns="https://twitter.com/RohanDhimal9" class="w-4 h-4" viewBox="0 0 24 24">
                <path fill="currentColor"
